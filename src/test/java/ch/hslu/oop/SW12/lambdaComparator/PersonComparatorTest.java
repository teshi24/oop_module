...
class PersonComparatorTest {
  ...
  // final Comparator<Person> personComparator = (Person person1, Person person2) -> person1.compareTo(person2);
  final Comparator<Person> personComparator = Person::compareTo;
