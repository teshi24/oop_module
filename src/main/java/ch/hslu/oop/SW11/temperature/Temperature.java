...
public final class Temperature implements Comparable<Temperature> {
  ...
  public Temperature(final Temperature currentTemperature) {
    currentTemperatureInCelsius = currentTemperature.getCurrentTemperatureInCelsius();
  }
  ...
  public final boolean equals(final Object o) {
    ...
    return Double.compare(temperature.currentTemperatureInCelsius, currentTemperatureInCelsius) == 0;
  }
  ...
  public int compareTo(final Temperature temperature) {
    ...
    return Double.compare(currentTemperatureInCelsius, temperature.currentTemperatureInCelsius);
  }
  ...
  */
  @Override
  public String toString() {
    return currentTemperatureInCelsius + " °C";
  }
}
